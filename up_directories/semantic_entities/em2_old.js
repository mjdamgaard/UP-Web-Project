...
export const webApps = {
  ...
  "Description": abs("./em2_old.js;get/webAppsDesc"),
};
...
export const indexPages = {
  ...
  "Name": "Index pages",
  "Superclass": abs("./em1.js;get/components"),
  "Description": abs("./em2_old.js;get/indexPagesDesc"),
};
...
export const upIndexPage01 = {
  "Class": abs("./em1.js;get/components"),
  "Name": "Index page 1.0",
  "Component path": abs("../base_app/index_pages/IndexPage01.jsx"),
  "Example component path": undefined,
  "Public repository":
    "https://github.com/mjdamgaard/UP-Web-Project/tree/main/" +
    "dir_uploads/up_directories/base_app/index_pages",
  "Creator(s)": getUserEntPath("1", "1"),
  "Description": undefined,
};
...
export const upIndexPage02 = {
  ...
  "Component path": abs("../base_app/index_pages/IndexPage02.jsx"),
  "Example component path": undefined,
  "Public repository":
    "https://github.com/mjdamgaard/UP-Web-Project/tree/main/" +
    "dir_uploads/up_directories/base_app/index_pages",
...
export const introTutorials = {
  ...
  "Superclass": abs("./em1.js;get/components"),
  "Description": abs("./em2_old.js;get/introTutorialsDesc"),
};
...
export const advTutorials = {
  ...
  "Superclass": abs("./em1.js;get/components"),
  "Description": abs("./em2_old.js;get/advTutorialsDesc"),
};
