...
// This is the old "AppMain" from my previous "Home app," which uses a page
// cache to keep the recent pages in memory. I might want to use this for e.g.
// the EntityBrowser app, which is why I've copied this old code here, just so
// I have it right at hand if I need it.
...
import * as EntityPage from
  "./variable_components/EntityPage.jsx";
...
import * as ComponentEntityPage from
  "./variable_components/ComponentEntityPage.jsx";
