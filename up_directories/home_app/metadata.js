export default {
  ...
  "Public repository": "https://github.com/mjdamgaard/UP-Web-Project/tree/main/up_directories/home_app",
  "Description": <div>
    <h2>Home app</h2>
    <h3>Summary</h3>
    <p>
      A "home app" is the fundamental app that used to load other apps within
      it, depending on the URL. And it also defines a global header menu and
      layout surrounding the loaded apps.
    </p>
    <p>
      When loading an app, the home app should generally query for the best
    ...
    <h3>API notes</h3>
    <p>
      All home apps should conform to following web API: If the first segment
      ...
      redefined by the home app version). And if the whole segment consists
    ...
    <p>
      After having loaded the given app, the home app should also generally
      ...
      this, it means that when a user shares a URL with another user, the home
    ...
    <p>
      Lastly, if the first segment equals "home" followed by second segment
      that is the directory ID of a trusted home app version, load that
      particular home app (and instruct it to not load an updated version of
      itself).
    </p>
