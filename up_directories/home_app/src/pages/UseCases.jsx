...
export function render() {
  return <div className="page use-cases-page">

    <h2>Use cases for this platform</h2>
    ...
    <p>
      ...
      will in turn help attract an even larger user base.  
    </p>
    <p>
      The users will also be able to help each other by creating and
      sharing templates for profile pages, making it easy for even
      inexperienced users to create well-designed profile pages. 
    </p>
    ...
    <p>
      ...
      allow users to share templates for user group pages with each other.
      And since such templates can implement their own accompanying back end as
      well, there is no limit to what kind of tools and widgets you can get for
      your user group:
    {/* </p> */}
    <ul>
      <li>
        Maybe you want more than just a single wall of posts for your user
        group? Maybe you want to be able to create specific sub-threads for
        specific subjects, and with a specific set of moderators?
      </li>
      <li>
        Maybe you want a shared calender widget where you can see all the
        events that relates to the group in one place?
      </li>
      <li>
        Maybe you want to be able to create formal votes for the members of
        the group, with a fixed deadline, and where the members get
        notifications that help remind them to cast their vote?
      </li>
      <li>
        Maybe you want a tool to help you organize things for the group, such
        as planning responsibilities, scheduling carpools, etc.?
      </li>
      <li>
        Maybe you want some shared documents that only the members of the group
        have access to, and where the members can potentially edit these
        documents?
      </li>
      <li>
        And maybe you want non-members to also have access to some public pages
        of the user group, where they can update themselves on the goings-on of
        the group, and potentially submit questions or requests to it?
      </li>
    </ul>
    {/* <p> */}
      Everything that that you can imagine for a website or app is also
      possible for these customized user groups.
    </p>
    <p>
    ...
    <p>
      ...
      for different templates and tools to use for the user groups.
    </p>


    <h3>Cheap business applications</h3>
    <p>
