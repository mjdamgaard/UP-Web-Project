...
varIdentPatt = "/^upav_[\w\$]+$/";
funIdentPatt = "/^upaf_[\w\$]+$/";


function parseVarIdent(lexArr, nextPos, successRequired) {
...
function parseFunIdent(lexArr, nextPos, successRequired) {
...
function parseVarIdentList(lexArr, nextPos, successRequired) {
